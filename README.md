...
- ### Hash table
    ...
    - [x] Implement with array using linear probing
        ...
        - get(key)
        - remove(key)
    - [x] Implement the Rabin-Karp Algorithm
...
- [x] Implement:
    ...
    - [x] Selection sort and insertion sort are both O(n^2) average and worst case
        - [x] Selection Sort
        - [x] Insertion Sort
    - [x] Heapsort, see Heap data structure above
    - [x] Bucket Sort
...
- I'll implement:
    ...
    - [x] single-source shortest path (Dijkstra)
        - Use Min-Heap to extract min from ADT
            - Reason is to get the highest priority node (least score) from graph
        - Look into Fibonacci Heap?
...
- ### Design patterns
    ...
    - [x] Learn these patterns (https://refactoring.guru/design-patterns):
        - [x] strategy
        - [x] singleton
        - [x] adapter
        - [x] prototype
